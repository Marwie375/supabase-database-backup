...
ALTER TABLE "public"."cio" OWNER TO "postgres";


ALTER TABLE "public"."cio" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."cio_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE ONLY "public"."cio"
    ADD CONSTRAINT "cio_pkey" PRIMARY KEY ("id");
...
CREATE POLICY "Enable read access for all users" ON "public"."cio" FOR SELECT USING (true);
...
ALTER TABLE "public"."cio" ENABLE ROW LEVEL SECURITY;
...
GRANT ALL ON TABLE "public"."cio" TO "anon";
GRANT ALL ON TABLE "public"."cio" TO "authenticated";
GRANT ALL ON TABLE "public"."cio" TO "service_role";



GRANT ALL ON SEQUENCE "public"."cio_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."cio_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."cio_id_seq" TO "service_role";
